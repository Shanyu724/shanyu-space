...
export function BlogClient({ posts, categories, labels }: BlogClientProps) {
  ...
  const totalCount = filter === "all" ? posts.length : posts.filter((p) => p.category === filter).length;
                  ...
                  return (
                    <section key={cat.id}>
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-[11px] text-mint-400 ml-auto">
                          {list.length} 篇
                        </span>
                      </div>
                      {/* 文章项 */}
    ...
    <li>
      ...
      >
        ...
        <div className="flex items-center gap-2 mt-1">
          ...
          <span className="text-[11px] text-mint-400 tabular-nums">
